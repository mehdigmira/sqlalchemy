...
def t_entity_varieties() -> None:
    ...
    # EXPECTED_TYPE: Result[int, User, str]
    reveal_type(r1)
    ...
    # EXPECTED_TYPE: Select[int, int, User, User]
    reveal_type(s3)
...
def t_connection_execute_single() -> None:
    ...
    # EXPECTED_RE_TYPE: sqlalchemy.*CursorResult\[builtins.str\*?\]
    reveal_type(result)
    row = result.one()

    # EXPECTED_TYPE: tuple[str, fallback=Row[str]]
    reveal_type(row)
...
def t_session_execute_multi() -> None:
    result = session.execute(multi_stmt)

    # EXPECTED_RE_TYPE: sqlalchemy.*Result\[builtins.int\*?, builtins.str\*?\]
    reveal_type(result)
    row = result.one()
...
def t_session_execute_single() -> None:
    result = session.execute(single_stmt)

    # EXPECTED_RE_TYPE: sqlalchemy.*Result\[builtins.str\*?\]
    reveal_type(result)
    row = result.one()
...
async def t_async_connection_execute_multi() -> None:
    result = await async_connection.execute(multi_stmt)
...
async def t_async_connection_execute_single() -> None:
    result = await async_connection.execute(single_stmt)
...
async def t_async_session_execute_multi() -> None:
    result = await async_session.execute(multi_stmt)
...
async def t_async_connection_stream_multi() -> None:
    result = await async_connection.stream(multi_stmt)

    # EXPECTED_RE_TYPE: sqlalchemy.*AsyncResult\[builtins.int\*?, builtins.str\*?\]
    reveal_type(result)
...
async def t_async_connection_stream_single() -> None:
    ...
    # EXPECTED_RE_TYPE: sqlalchemy.*AsyncResult\[builtins.str\*?\]
    reveal_type(result)
    row = await result.one()
...
async def t_async_session_stream_multi() -> None:
    result = await async_session.stream(multi_stmt)
...
async def t_async_session_stream_single() -> None:
    result = await async_session.stream(single_stmt)
